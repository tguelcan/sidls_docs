...
<style lang="postcss">
	.example-card {
		@apply h-32 !bg-light/50 transition-colors group-hover:!bg-light;
	}

	.example-info {
		@apply transition-colors group-hover:text-primary;
	}
</style>
